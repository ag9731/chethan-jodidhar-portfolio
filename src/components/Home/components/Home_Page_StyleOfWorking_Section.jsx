    ...
    <section className="bg-[#faf5fa] py-24">
      <div className="flex flex-col items-center justify-center gap-8 container mx-auto">
        ...
        <p className="text-center leading-6">
          ...
          his later work has evolved into a unique amalgamation of high-stakes
          action and intimate emotional beats. While staying true to the
          fundamentals of mass entertainment, Chethan has developed a reputation
        ...
        <p className="text-center leading-6">
          ...
          technically has allowed him to stay ahead of trends in an
          ever-changing cinematic landscape. With a keen eye for detail, he
          blends the power of technology with timeless storytelling techniques,
          resulting in films that are visually and narratively unique.
        </p>
      </div>
    </section>
  );
...
export default Home_Page_StyleOfWorking_Section
